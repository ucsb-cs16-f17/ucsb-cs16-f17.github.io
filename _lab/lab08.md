...
Each corresponds to one of the problems listed below, which make up this lab. Each of the programs is worth 40 points on submit.cs. (the total score will be normalized to be 100 points). Each should be solved in its own file and each must be submitted for full assignment credit. 
